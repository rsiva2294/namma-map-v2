# NammaMap V2 - User Guide

Welcome to **NammaMap**, your high-performance GIS portal for accessing essential services in Tamil Nadu.
...
### Finding PDS Shops
1.  Switch the active layer to **PDS** in the sidebar.
2.  Search for your area name or pincode.
3.  The map will automatically display all ration shops (Red markers) in that area.
4.  Click any marker to view the Shop Code, Village, and get driving directions.

### Finding your TNEB Office
1.  Switch the active layer to **TNEB**.
...
## 💡 Pro Tips
*   **Map Interaction**: You can click anywhere on the map to "resolve" the jurisdiction for that point.
*   **Dark Mode**: Use the theme toggle in the sidebar for a comfortable viewing experience at night.
*   **Sidebar**: On mobile, the sidebar can be collapsed to give you more room for the map.
